...
public class Graph extends FrameLayout
{
    ...
    ArrayList<int[][]> accel_data = new ArrayList<>();
    ...
    void set_layout(int i)
    {
        switch(i)
        {
            case 0:
                ...
                inflate(getContext(), R.layout.activity_main_sensor,this);//R.layout.choose_graph
                //layout = -1;
                break;
            case 1:
                System.out.println("set_layout reps graph");
                inflate(getContext(),R.layout.reps_graph_layout,this);
                //layout = 1;
                break;
            case 2:
    ...
    //add accel points to arraylist<int[][]> accel_data
    void init_accel(int[][] array)
    {
        accel_data.add(array);
    }
    ...
    */
    ...
    void add_pointsF(String str,float [][] array)
    {
        //ArrayList<Points> line = new ArrayList<>();
    ...
    void set_zero(Canvas canvas)
    {
        //float zero_y = (float) (origin.y - (calendar_h/2.0));

        paint.setColor(Color.RED);
        canvas.drawLine(origin.x,zero_y,origin.x + calendar_w,zero_y,paint);
    }
